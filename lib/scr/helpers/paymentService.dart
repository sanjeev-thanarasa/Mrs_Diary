...
class PaymentServices {
  ...
  void createPaymentRecord({required String userId}) async {
    addPayment = {
      "USER_ID": userId,
  ...
  void updatePaymentRecord({required QueryDocumentSnapshot snapshot}) async {
    ...
    updatePayment = {
      ...
      "PENDING_AMOUNT": pendingAmount.text,
      "PENDING_DATE":
          newGiveAmount.text == rechargeAmount.text ? null : pendingDate,
      "BALANCE_AMOUNT": balanceAmount.text,
      "USER_NOTE": userNote.text,
      "USER_NOTE2": userNote2.text,
