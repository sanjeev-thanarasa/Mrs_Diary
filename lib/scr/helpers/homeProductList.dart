...
List<HomeProduct> homeProductList = [
  ...
  HomeProduct(
      ...
      text: "பழைய பயனர்கள்",
      onTapCard: (context) =>
          changeScreenAnimated(context, TotalOldCustomers())),
  HomeProduct(
      image: "assets/images/users1.png",
      text: "புதிய பயனர்கள்",
      onTapCard: (context) =>
          changeScreenAnimated(context, TotalNewCustomers())),
  HomeProduct(
      image: "assets/images/payment.png",
      text: "இன்று பணம் தர வேண்டியவர்கள்",
      onTapCard: (context) =>
          changeScreenAnimated(context, TodayPaymentUsers())),
  HomeProduct(
      image: "assets/images/recharge.png",
      text: "இன்று Recharge முடியும் நபர்கள்",
      onTapCard: (context) =>
          changeScreenAnimated(context, TodayPackageExpiredUsers())),
  HomeProduct(
      image: "assets/images/balance.png",
      text: "கொடுமதிகள்",
      onTapCard: (context) =>
          changeScreenAnimated(context, TotalBalanceUsers())),
  HomeProduct(
      image: "assets/images/currency.png",
      text: "தருமதிகள்",
      onTapCard: (context) =>
          changeScreenAnimated(context, TotalPendingUsers())),
  HomeProduct(
  ...
  HomeProduct(
      ...
      text: "குறிப்புகள்",
      onTapCard: (context) =>
          changeScreenAnimated(context, const NotesScreen())),
];
